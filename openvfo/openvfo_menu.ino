...
Ian OPENVFO-Consortium
 */
 
#include "openvfo.h"
#include "openvfo_eemap.h"

//Current Frequency and mode to active VFO by OPENVFO-Consortium
...
//Commonly called functions when exiting menus by OPENVFO-Consortium
...
//Ham band or general band movement by OPENVFO-Consortium
...
//Convert Number to Mode by OPENVFO-Consortium
//autoSetModebyFreq : 0
...
//Memory to VFO, VFO to Memory by OPENVFO-Consortium
...
//VFO Toggle and save VFO Information, modified by OPENVFO-Consortium
...
//Split communication using VFOA and VFOB by OPENVFO-Consortium
...
//Builtin CW Keyer Logic by OPENVFO-Consortium
...
//Modified by OPENVFO-Consortium
...
//CW Time delay by OPENVFO-Consortium
...
//IF Shift function, BFO Change like RIT, by OPENVFO-Consortium
...
//ATT SETUP (IF1(45MHZ) SHIFT), by OPENVFO-Consortium
...
//Functions for CWL and CWU by OPENVFO-Consortium
...
//Select CW Key Type by OPENVFO-Consortium
...
//Lock Dial move by OPENVFO-Consortium
...
void doMenu(){
  ...
  //Appened Lines by OPENVFO-Consortium for Adjust Tune step and Set Dial lock
  while(btnDown()){
    delay_background(50, 0);
  ...
  //Below codes are origial code with modified by OPENVFO-Consortium
  menuOn = 2;
  TriggerBySW = 0;  //Nextion LCD and Other MCU

  //*********************************************************************************
  // New type menu for developer by OPENVFO-Consortium
  // Selectable menu
  // Version : 1.097 ~
  //*********************************************************************************
...
//modified for reduce used flash memory by OPENVFO-Consortium
 ...
 */
 ...
 //this is used by the si5351 routines in the openvfo_5351 file
...
//modified by OPENVFO-Consortium (just 1 line remarked //usbCarrier = ...
void menuSetupCarrier(int btn){
  ...
  //usbCarrier = 11995000l; //Remarked by OPENVFO-Consortium, Suggest from many user, if entry routine factoryrest
  /*
  //for OpenVFO V5.0, but not used by OPENVFO-Consortium, if you want default value of carrier on Calibration, delete remark symbols
#if OPENVFO_BOARD_VERSION == 5
