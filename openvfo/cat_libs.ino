/*************************************************************************
  ...
  the serial port.
  it is based on FT-817, OpenVFO's only protocol has been added and will be added in the future.
...
//Read EEProm by OpenVFO Manager Software
...
//Read ADC Value by OpenVFO Manager Software
...
void Check_Cat(byte fromType)
{
  ...
  switch(CAT_BUFF[4])
  {
    ...
    case 0xDB:  //Read OpenVFO EEPROM Data
      ReadEEPRom(); //Call by OpenVFO Manager Program
      break;
    case 0xBB:  //Read FT-817 EEPROM Data  (for comfirtable)
      ReadEEPRom_FT817();
      break;

    case 0xDC:  //Write OpenVFO EEPROM Data
      WriteEEPRom(); //Call by OpenVFO Manager Program
      break;
    case 0xBC:  //Write FT-817 EEPROM Data  (for comfirtable)
      WriteEEPRom_FT817(fromType);
      break;

    case 0xDD:          //Read OpenVFO ADC Data
      ReadADCValue();   //Call by OpenVFO Manager Program
      break;
