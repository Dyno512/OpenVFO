/*************************************************************************
  OPENVFO-Consortium's OpenVFO Display Routine for LCD2004 Parrel & I2C
  1.This is the display code for the 20x04 LCD
  2.Some functions moved from OpenVFO_Ui.
-----------------------------------------------------------------------------
...
//========================================================================
//Begin of I2CTinyLCD Library by OPENVFO-Consortium
//========================================================================
#ifdef OPENVFO_DISPLAY_LCD2004I
...
**************************************************************************/
#define OPENVFO_DISPLAY_LCD2004_BASE
...
#endif
//========================================================================
//End of I2CTinyLCD Library by OPENVFO-Consortium
//========================================================================
...
//========================================================================
#ifdef OPENVFO_DISPLAY_LCD2004_BASE
...
void updateDisplay() {
  ...
  // replace code for Frequency numbering error (alignment, point...) by OPENVFO-Consortium
  ...
  //remarked by OPENVFO-Consortium
