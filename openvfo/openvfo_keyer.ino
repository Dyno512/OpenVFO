/**
 CW Keyer
 CW Key logic change with ron's code (openvfo_keyer.cpp)
 Ron's logic has been modified to work with the original OpenVFO by OPENVFO-Consortium
...
void cwKeydown(){
  ...
  //Modified by OPENVFO-Consortium, for CW Delay Time save to eeprom
...
//create by OPENVFO-Consortium for compatible with new CW Logic
  ...
  if( Iambic_Key ) {
    ...
    while(1){
      if (update_PaddleLatch(0) == DIT_L) {
        ...
        //if (!cwTimeout) //removed by OPENVFO-Consortium
        //   return;
        // got back to the beginning of the loop, if no further activity happens on straight key
        // we will time out, and return out of this routine 
        //delay(5);
        //delay_background(5, 3); //removed by OPENVFO-Consortium
        //continue;               //removed by OPENVFO-Consortium
